...
private:
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load("textures/halo.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
        ...
        transitionImageLayout(textureImage, VK_FORMAT_R8G8B8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED,
